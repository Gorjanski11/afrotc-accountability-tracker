...
import type { RosterPersonUpdate } from "../hooks/useRoster";

interface Props {
  open: boolean;
  onClose: () => void;
  person: RosterPerson;
  onSave: (input: RosterPersonUpdate) => Promise<void>;
}
    ...
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent>
        ...
        <p className="text-sm text-muted-foreground">
          Name, AS Class, and Dev Level are managed from the TO's site's Roster -- this only edits the fields specific to Accountability.
        </p>
