...
import type { Attendance, PmtEvent, RosterPerson } from "./types";
...
export function computeUnitComparison(
  ...
  unitOf: (p: RosterPerson) => string | undefined
): UnitComparisonRow[] {
  const byUnit = new Map<string, RosterPerson[]>();
...
export function unitOfAxis(axis: UnitAxis, p: RosterPerson): string | undefined {
